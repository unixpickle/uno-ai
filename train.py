...
def arg_parser():
    ...
    parser.add_argument('--epsilon', help='PPO epsilon', default=0.1, type=float)
    parser.add_argument('--iters', help='PPO iterations', default=64, type=int)
    parser.add_argument('--players', help='number of players', default=4, type=int)
    parser.add_argument('--batch', help='rollouts per batch', default=256, type=int)
